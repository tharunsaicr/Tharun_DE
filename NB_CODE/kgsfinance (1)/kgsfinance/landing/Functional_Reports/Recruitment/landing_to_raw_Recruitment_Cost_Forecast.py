...
for name in trimDf.columns:
        trimDf = trimDf.withColumnRenamed(name,colNameTrim(name,"_"))
...
load_df=trimDf.withColumn('Financial_Year',lit(FinYear)).withColumn("Dated_On", to_timestamp(lit(currentdatetime)))
display(load_df)
