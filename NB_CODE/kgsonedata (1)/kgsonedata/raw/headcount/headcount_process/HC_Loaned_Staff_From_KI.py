...
tableName = "loaned_staff_from_ki"
processName = "headcount"

# COMMAND ----------

finaldf = spark.sql("select * from kgsonedatadb.raw_curr_headcount_loaned_staff_from_ki")
...
finaldf = finaldf.withColumn("Employee_Number", regexp_replace(col("Employee_Number")," ","")).withColumn("Employee_Number", trim(col("Employee_Number")))

finaldf = finaldf.withColumn("Employee_Number", finaldf["Employee_Number"].cast(StringType()))
