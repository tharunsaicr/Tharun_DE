...
.saveAsTable("kgsonedatadbedw."+ processName + "_" +tableName)

# COMMAND ----------

# DBTITLE 1,Load data to history
histTableName = "kgsonedatadbedw."+ processName + "_hist_" + tableName
...
if spark._jsparkSession.catalog().tableExists(histTableName):
    ...
    .option("compression","snappy") \
    .saveAsTable("kgsonedatadbedw."+ processName + "_hist_" +tableName)
