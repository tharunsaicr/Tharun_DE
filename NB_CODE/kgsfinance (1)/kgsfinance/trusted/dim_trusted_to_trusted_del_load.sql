...
-- MAGIC %py
-- MAGIC #dbutils.widgets.remove("Year")
...
CREATE WIDGET TEXT File_Year DEFAULT ""

-- COMMAND ----------

CREATE WIDGET TEXT File_Month DEFAULT ""
...
-- MAGIC File_Year = dbutils.widgets.get("File_Year")
-- MAGIC File_Month = dbutils.widgets.get("File_Month")
-- MAGIC
-- MAGIC print(hist_table_name)
-- MAGIC print(curr_table_name)
-- MAGIC print(File_Year)
-- MAGIC print(File_Month)
...
delete from $hist_table_name where concat(File_Year,File_Month)  in (select distinct(concat(File_Year,File_Month)) from $curr_table_name) 
