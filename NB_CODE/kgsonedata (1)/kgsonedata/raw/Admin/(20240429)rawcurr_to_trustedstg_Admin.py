...
currentDf = spark.sql("select * from kgsonedatadb.raw_hist_"+processName + "_"+ tableName+" where location like '%HYD%' and file_date = '20240414'" )
display(currentDf)
...
# display(currentDf.filter(currentDf.File_Date == '20240415'))
