...
tableName = "loaned_staff_resigned"
processName = "headcount"

# COMMAND ----------

finaldf = spark.sql("select * from kgsonedatadb.raw_curr_headcount_loaned_staff_resigned")
...
# %sql
# select * from kgsOneDataDb.trusted_hist_headcount_loaned_staff_resigned