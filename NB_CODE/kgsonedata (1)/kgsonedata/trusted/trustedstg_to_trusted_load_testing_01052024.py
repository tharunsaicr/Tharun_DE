...
currentDf = spark.sql("select * from kgsonedatadb.testing_01052024_trusted_stg_"+processName + "_" + tableName)
...
.option("path",trusted_curr_savepath_url+processName+"/testing_01052024_"+tableName) \
.option("compression","snappy") \
.saveAsTable("kgsonedatadb.testing_01052024_trusted_"+ processName + "_" + tableName)
...
# .option("compression","snappy") \
# .saveAsTable("kgsonedatadb.testing_01052024_trusted_hist_"+ processName + "_" + tableName)
