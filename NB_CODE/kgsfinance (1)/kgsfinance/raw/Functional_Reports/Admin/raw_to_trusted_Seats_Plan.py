...
raw_curr_seats_url=finance_raw_curr_savepath_url+reportName+"/"+processName+"/"+tableName
print(raw_curr_seats_url)
read_df= spark.read.format("delta").load(raw_curr_seats_url)
display(read_df)
...
cast_df=unpivotedDf.select("*").drop("YYYYMM") \
