...
CREATE WIDGET TEXT check_col_name DEFAULT ""
...
-- MAGIC check_col_name = dbutils.widgets.get("check_col_name")
-- MAGIC reportName= dbutils.widgets.get("ReportName")
-- MAGIC currentdatetime= datetime.now()
-- MAGIC print(hist_table_name)
-- MAGIC print(curr_table_name)
-- MAGIC print(check_col_name)
...
delete from $hist_table_name where $check_col_name in (select distinct $check_col_name from $curr_table_name) 
