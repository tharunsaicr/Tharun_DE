...
if len(dateList) > 0:
    ...
    for columnName in currentDf.columns:
        ...
        if (columnName in dateList):
            ...
            .when((((currentDf[columnName].isNull()) | (currentDf[columnName] == "#N/A") | (currentDf[columnName] == "NA") | (currentDf[columnName] == "0-Jan-00") | (currentDf[columnName] == "00 January 1900") | (upper(trim(currentDf[columnName])) == "DATA NOT AVAILABLE") | (upper(trim(currentDf[columnName])) == "TO BE SCHEDULED") | (trim(currentDf[columnName]) == "") | (currentDf[columnName] == " ") | (trim(currentDf[columnName]) == "-") | (trim(currentDf[columnName]) == "_")) & currentDf[columnName].cast(DateType()).isNull()),lit("Source is Null"))\
