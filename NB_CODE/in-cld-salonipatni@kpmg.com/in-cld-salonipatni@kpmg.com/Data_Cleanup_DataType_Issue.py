...
for columnName in currentDf.columns:
    ...
    if (columnName in dateList):
        ...
        .when(to_date(currentDf[columnName], 'dd MMM yy').isNotNull(),lit(""))\
        .when(to_date(currentDf[columnName], 'yyyy/MM/dd').isNotNull(),lit(""))\
        .when((((currentDf[columnName].isNull()) | (currentDf[columnName] == "#N/A") | (currentDf[columnName] == "0-Jan-00") | (trim(currentDf[columnName]) == "") | (currentDf[columnName] == " ")) & currentDf[columnName].cast(DateType()).isNull()),lit("Source is Null"))\
...
for columnName in currentDf.columns:
    ...
    if (columnName in dateList):
        ...
        when(to_date(currentDf[columnName], 'yyyy-MM-dd').isNotNull(),to_date(currentDf[columnName].cast(DateType()), 'yyyy-MM-dd'))\
        .when(to_date(currentDf[columnName], 'dd/MM/yyyy').isNotNull(),to_date(currentDf[columnName].cast(DateType()), 'dd/MM/yyyy'))\
        .when(to_date(currentDf[columnName], 'MM/dd/yyyy').isNotNull(),to_date(currentDf[columnName].cast(DateType()), 'MM/dd/yyyy'))\
        .when(to_date(currentDf[columnName], 'dd-MM-yyyy').isNotNull(),to_date(currentDf[columnName].cast(DateType()), 'dd-MM-yyyy'))\
        .when(to_date(currentDf[columnName], 'dd-MMM-yyyy').isNotNull(),to_date(currentDf[columnName].cast(DateType()), 'dd-MMM-yyyy'))\
        .when(to_date(currentDf[columnName], 'dd-MMMM-yyyy').isNotNull(),to_date(currentDf[columnName].cast(DateType()), 'dd-MMMM-yyyy'))\
        .when(to_date(currentDf[columnName], 'dd MMMM, yyyy').isNotNull(),to_date(currentDf[columnName].cast(DateType()), 'dd MMMM,yyyy'))\
        .when(to_date(currentDf[columnName], 'dd-MM-yy').isNotNull(),to_date(currentDf[columnName].cast(DateType()), 'dd-MM-yy'))\
        .when(to_date(currentDf[columnName], 'dd-MMM-yy').isNotNull(),to_date(currentDf[columnName].cast(DateType()), 'dd-MMM-yy'))\
        .when(to_date(currentDf[columnName], 'dd MMM yy').isNotNull(),to_date(currentDf[columnName].cast(DateType()), 'dd MMM yy'))\
        .when(to_date(currentDf[columnName], 'yyyy/MM/dd').isNotNull(),to_date(currentDf[columnName].cast(DateType()), 'yyyy/MM/dd'))\
        .otherwise(currentDf[columnName]))
    ...
    if (columnName in floatList):
        ...
        currentDf= currentDf.withColumn(columnName+'_Test',when((((currentDf[columnName].isNotNull())  & (trim(currentDf[columnName]) != "") ) & currentDf[columnName].cast(FloatType()).isNotNull()),col(columnName).cast(FloatType()))\
        .otherwise(currentDf[columnName]))
