...
if (processName.lower() == 'admin') & (tableName.lower() in ['transport_data_pune', 'transport_data_kolkata', 'transport_data_bangalore', 'transport_data_kochi', 'transport_data_gurgaon', 'no_shows_pune', 'no_shows_kolkata', 'no_shows_,kochi', 'no_shows_bangalore', 'no_shows_gurgaon']):
