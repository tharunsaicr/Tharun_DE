...
# This NB handles Cost Plan & Forecast 
...
drop_col1= fileYear+"_Forecast_Full_Year"
drop_col2= fileYear+"_Plan_Full_Year"
drop_col3= fileYear+"_Outlook_Full_Year"
col_list=['AMC_period','Cost','GDC_to_share_the_cost_or_Not',drop_col1,drop_col2,drop_col3,'Comments','Covid_related_extended_monthly_spend','FY21_Forecast_5__plus_7','Monthly_extrapolated_Cost']
print(col_list)
currentDf=currentDf.drop(*col_list)

drop_col_df=currentDf.select(currentDf.colRegex("`.+(YTD)`")).columns
print(drop_col_df)
currentDf=currentDf.drop(*drop_col_df)
...
drop_col_df=currentDf.select(currentDf.colRegex("`c.+`"))
...
# DBTITLE 1,Deriving   financial_year and CurrentTime 
