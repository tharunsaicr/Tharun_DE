...
if (tableName == 'dim_training_category'):
    currentDf=currentDf.withColumn('ItemTitle',ascii_udf('ItemTitle'))
...
display(currentDf.filter(currentDf.ItemTitle.like('%�%')))
...
.saveAsTable("kgsonedatadb."+ processName + "_test_lnd_" +tableName)
