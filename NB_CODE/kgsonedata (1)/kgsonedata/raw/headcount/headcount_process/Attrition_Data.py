...
tableName = "attrition_data"
processName = "headcount"

# COMMAND ----------

finaldf = spark.sql("select * from kgsonedatadb.raw_curr_headcount_attrition_data")
...
finaldf = finaldf.withColumn("Dated_On", to_timestamp(lit(currentdatetime)))
