...
df_currentED = spark.sql("select * from kgsonedatadb.test_raw_curr_headcount_employee_dump")

df_currentTD = spark.sql("select Employee_Number as TD_Employee_Number from kgsonedatadb.test_raw_curr_headcount_termination_dump")
...
df_currentED = df_currentED.withColumn("Termination_Date",lit(""))
...
dropEmpDtlsColumns = ("curr_Emp_Num","Dated_On","BU","Requested_By","Current_Base_Location_of_the_Candidate","Office_Location_in_the_KGS_Offer_Letter","WFA_Option__Permanent_12_Months_","_c30","_c31","_c32","Employee_Subfunction","Employee_Subfunction_1","Remarks")
...
.option("path",trusted_stg_savepath_url+processName+"/employee_dump_test") \
.option("compression","snappy") \
.saveAsTable("kgsonedatadb.test_trusted_stg_"+ processName + "_" +table_name)
