...
currentDf=currentDf.withColumn('MMM',upper(substring(col("Month"),0,3))).withColumnRenamed("Amount","Net_Amount")

currentDf=currentDf.withColumn("Service_line_Mapping",concat(col("BU"),lit(" "),col("Service_line")))\
...
# DBTITLE 1,Current table names & path
...
# DBTITLE 1,Current & Hist table name and  path
