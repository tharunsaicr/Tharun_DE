...
tableName = "qualification_dump"
processName = "compensation_non_sensitive"

# COMMAND ----------

finaldf = spark.sql("select * from kgsonedatadb.raw_curr_compensation_non_sensitive_qualification_dump")
