...
#remove lead and trail underscores    
...
# DBTITLE 1,remove columns with all null values
#import pyspark.sql.functions as sqlf
...
#Add additional column 'Merged' - concatenate CC# and Geo_Codes
df = df.withColumn("Merged", concat(col("CC#"),lit(" "),col("Geo_Codes")))
df = df.withColumnRenamed("CC#", "CC")
