...
#CH Leads Mapping
# kgsfinancedb.raw_hist_BU_year_classification
# kgsfinancedb.raw_hist_BU_cf_headcount_remarks
# kgsfinancedb.raw_hist_BU_cf_function
...
print("TrustedTableName   :"+tableName)
