...
#change col types
currentDf = currentDf.withColumn("Total_Costs_Including_Mark_up", currentDf.Total_Costs_Including_Mark_up.cast("double"))
currentDf = currentDf.withColumn("Total_Hours", currentDf.Total_Hours.cast("double"))
currentDf = currentDf.withColumn("Total_HC", currentDf.Total_HC.cast("double"))
