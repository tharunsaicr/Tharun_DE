...
df = leadtrailremove(df)
display(df)

# COMMAND ----------

#reanme column Geo Alias to Geo Level 2
df = df.withColumnRenamed("Geo_Alias","Geo_Level_2")
