...
# MAGIC %sql
# MAGIC drop table kgsonedatadb.raw_stg_risk_laptop_ageing
...
# MAGIC %sql
# MAGIC drop table kgsonedatadb_badrecords.risk_laptop_recovery_bad

# COMMAND ----------

# MAGIC %sql
# MAGIC drop table kgsonedatadb_badrecords.risk_laptop_ageing_bad
...
# MAGIC %fs
# MAGIC rm -r dbfs:/mnt/trustedlayermount/current/risk/laptop_ageing
...
# MAGIC %fs
# MAGIC rm -r dbfs:/mnt/trustedlayermount/staging/risk/laptop_ageing

# COMMAND ----------

# MAGIC %fs
# MAGIC rm -r dbfs:/mnt/trustedlayermount/history/risk/laptop_ageing
