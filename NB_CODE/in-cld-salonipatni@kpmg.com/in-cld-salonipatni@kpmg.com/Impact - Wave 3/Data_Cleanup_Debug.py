...
currentDf = spark.sql("select * from kgsonedatadb.raw_hist_"+processName + "_"+ tableName)
...
if len(dateList) > 0:
    ...
    for columnName in currentDf.columns:
        ...
        if (columnName in dateList):
            ...
            .when((((currentDf[columnName].isNull()) | (currentDf[columnName] == "#N/A") | (currentDf[columnName] == "NA") | (currentDf[columnName] == "0-Jan-00") | (upper(trim(currentDf[columnName])) == "DATA NOT AVAILABLE")  | (trim(currentDf[columnName]) == "") | (currentDf[columnName] == " ") | (trim(currentDf[columnName]) == "-")) & currentDf[columnName].cast(DateType()).isNull()),lit("Source is Null"))\
...
if len(doubleList) > 0:
    ...
    for columnName in currentDf.columns:
        ...
        if (columnName in doubleList):
            ...
            currentDf= currentDf.withColumn(varDoubleConversion,when((((currentDf[columnName].isNotNull()) &  (trim(currentDf[columnName]) != "") & (trim(currentDf[columnName]) != "NA")) & currentDf[columnName].cast(DoubleType()).isNull()),lit("Double Type Cast Issue"))\
            .when((((currentDf[columnName].isNull()) | (trim(currentDf[columnName]) == "") | (trim(currentDf[columnName]) == "NA")) & currentDf[columnName].cast(DoubleType()).isNull()),lit("Source is Null"))\
...
if len(intList) > 0:
    ...
    for columnName in currentDf.columns:
        ...
        if (columnName in intList):
            ...
            currentDf = currentDf.withColumn(varIntConversion,when((((currentDf[columnName].isNotNull()) &  (trim(currentDf[columnName]) != "") & (trim(currentDf[columnName]) != "NA")) &  currentDf[columnName].cast(IntegerType()).isNull()),lit("Int Type Cast Issue"))\
            .when((((currentDf[columnName].isNull()) | (trim(currentDf[columnName]) == "") | (trim(currentDf[columnName]) == "NA")) & currentDf[columnName].cast(IntegerType()).isNull()),lit("Source is Null"))\
...
if len(floatList) > 0:
    ...
    for columnName in currentDf.columns:
        ...
        if (columnName in floatList):
            ...
            currentDf= currentDf.withColumn(varFloatConversion,when((((currentDf[columnName].isNotNull()) &  (trim(currentDf[columnName]) != "") & (trim(currentDf[columnName]) != "NA")) & currentDf[columnName].cast(FloatType()).isNull()),lit("Float Type Cast Issue"))\
            .when((((currentDf[columnName].isNull()) | (trim(currentDf[columnName]) == "") | (trim(currentDf[columnName]) == "NA")) & currentDf[columnName].cast(FloatType()).isNull()),lit("Source is Null"))\
...
if len(longList) > 0:
    ...
    for columnName in currentDf.columns:
        ...
        if (columnName in longList):
            ...
            currentDf = currentDf.withColumn(varLongConversion,when((((currentDf[columnName].isNotNull()) &  (trim(currentDf[columnName]) != "") & (trim(currentDf[columnName]) != "NA")) & currentDf[columnName].cast(LongType()).isNull()),lit("Long Type Cast Issue"))\
            .when((((currentDf[columnName].isNull()) | (trim(currentDf[columnName]) == "") | (trim(currentDf[columnName]) == "NA")) & currentDf[columnName].cast(LongType()).isNull()),lit("Source is Null"))\
...
if len(timestampList) > 0:
    ...
    for columnName in currentDf.columns:
        ...
        if (columnName in timestampList):
            ...
            currentDf = currentDf.withColumn(varTimeStampConversion,when((((currentDf[columnName].isNotNull()) &  (trim(currentDf[columnName]) != "") & (trim(currentDf[columnName]) != "NA")) & currentDf[columnName].cast("Timestamp").isNull()),lit("Timestamp Cast Issue"))\
            .when((((currentDf[columnName].isNull()) | (trim(currentDf[columnName]) == "") | (trim(currentDf[columnName]) == "NA") ) & currentDf[columnName].cast("Timestamp").isNull()),lit("Source is Null"))\
...
display(currentDf.filter(col('HR_ID') =='100257'))
...
str1=""
goodFilterCondition= '''select * from CurrentDfTempView where (upper(Is_Duplicate_Record) != "DUPLICATE RECORD") and (upper(Is_Primary_Key_Null) != "PK IS NULL") and (upper(Is_Primary_Duplicate_Record) != "PK DUPLICATE RECORD")  and (upper(Is_Column_Null) != "SOURCE NOT NULL") and (upper(Is_Primary_Duplicate_Record) != "PK DUPLICATE RECORD") and (upper(Is_Composite_Duplicate_Record) != "CK DUPLICATE RECORD")'''


if len(dropDateConversionColumnList) > 0:   
    
        for columnName in dropDateConversionColumnList:
            str2 = ' and (upper('+columnName+') != "DATE INVALID")'
            str1 = str1+str2
...
if len(dropDoubleConversionColumnList) > 0:
        ...
        for columnName in dropDoubleConversionColumnList:
            str2 = ' and (upper('+columnName+') != "DOUBLE TYPE CAST ISSUE")'
            str1 = str1+str2

if len(dropIntConversionColumnList) > 0:   
    
        for columnName in dropIntConversionColumnList:
            str2 = ' and (upper('+columnName+') != "INT TYPE CAST ISSUE")'
            str1 = str1+str2
...
if len(dropFloatConversionColumnList) > 0:
        ...
        for columnName in dropFloatConversionColumnList:
            str2 = ' and (upper('+columnName+') != "FLOAT TYPE CAST ISSUE")'
            str1 = str1+str2

if len(dropLongConversionColumnList) > 0:   
    
        for columnName in dropLongConversionColumnList:
            str2 = ' and (upper('+columnName+') != "LONG TYPE CAST ISSUE")'
            str1 = str1+str2
...
if len(dropTimeStampConversionColumnList) > 0:
        ...
        for columnName in dropTimeStampConversionColumnList:
            str2 = ' and (upper('+columnName+') != "TIMESTAMP CAST ISSUE")'
            str1 = str1+str2
...
display(goodDf.filter(col('HR_ID') =='100257'))
...
badFilterCondition= '''select * from CurrentDfTempView where (upper(Is_Duplicate_Record) = "DUPLICATE RECORD") or (upper(Is_Primary_Key_Null) = "PK IS NULL") or (upper(Is_Primary_Duplicate_Record) = "PK DUPLICATE RECORD")  or (upper(Is_Column_Null) = "SOURCE NOT NULL") or (upper(Is_Primary_Duplicate_Record) = "PK DUPLICATE RECORD") or (upper(Is_Composite_Duplicate_Record) = "CK DUPLICATE RECORD")'''


if len(dropDateConversionColumnList) > 0:   
    
        for columnName in dropDateConversionColumnList:
            str2 = ' or (upper('+columnName+') = "DATE INVALID")'
            str1 = str1+str2
...
if len(dropDoubleConversionColumnList) > 0:
        ...
        for columnName in dropDoubleConversionColumnList:
            str2 = ' or (upper('+columnName+') = "DOUBLE TYPE CAST ISSUE")'
            str1 = str1+str2

if len(dropIntConversionColumnList) > 0:   
    
        for columnName in dropIntConversionColumnList:
            str2 = ' or (upper('+columnName+') = "INT TYPE CAST ISSUE")'
            str1 = str1+str2
...
if len(dropFloatConversionColumnList) > 0:
        ...
        for columnName in dropFloatConversionColumnList:
            str2 = ' or (upper('+columnName+') = "FLOAT TYPE CAST ISSUE")'
            str1 = str1+str2

if len(dropLongConversionColumnList) > 0:   
    
        for columnName in dropLongConversionColumnList:
            str2 = ' or (upper('+columnName+') = "LONG TYPE CAST ISSUE")'
            str1 = str1+str2
...
if len(dropTimeStampConversionColumnList) > 0:
        ...
        for columnName in dropTimeStampConversionColumnList:
            str2 = ' or (upper('+columnName+') = "TIMESTAMP CAST ISSUE")'
            str1 = str1+str2
...
wave1List = ['bgv','employee_engagement','global_mobility','headcount','jml','talent_acquisition']
...
if (processName not in wave1List) or (tableName=='attrition_data'):
    ...
    for columnName in goodDf.columns:
        ...
        if (columnName in dateList):
            ...
            goodDf = goodDf.withColumn(columnName, when(((col(columnName) == " ") | (col(columnName) == "0-Jan-00") | (col(columnName).isNull()) | (upper(trim(currentDf[columnName])) == "DATA NOT AVAILABLE") | (trim(col(columnName)) == "") | (trim(col(columnName)) == "-") | (col(columnName) == "#N/A") | (col(columnName) == "NA")),"1900-01-01").otherwise(col(columnName)))
