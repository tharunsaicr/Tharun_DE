...
# This CFIT NB handles CFIT Cost Actual , forcast & Plan and CFIR HC Actual, forcast & Plan
...
# dropping the columns with respect to table names
if tableName == "cfit_hc_plan" or tableName == "cfit_hc_actual" or tableName == "cfit_hc_forecast" or tableName == "cfit_hc_outlook":
    df1=currentDf.select(currentDf.colRegex("`_c.+`"))
    df=df1.columns
    col_list=['Average',df[0]]
else:
    col_list=['Total']
print(col_list)
