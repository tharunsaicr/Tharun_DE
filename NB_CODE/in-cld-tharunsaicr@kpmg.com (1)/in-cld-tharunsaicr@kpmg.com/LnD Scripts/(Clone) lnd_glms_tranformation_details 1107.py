...
display(df_config_cc_bu_sl.filter((col('Cost_centre')=='Capability Hubs-KM-T&R-Infrastructure') & (col('Client_Geography')== 'CORPORATE') & (col('Final_BU')=='Cap-Hubs')))

display(df_config_cc_bu_sl.filter((col('Cost_centre')=='Capability Hubs-Corporate MGT') & (col('Client_Geography')== 'CORPORATE') & (col('Final_BU')=='Cap-Hubs')))
