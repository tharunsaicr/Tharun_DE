...
load_df=read_df.withColumn('Calendar_Year',when(f.lower(read_df['Month']).isin(month_list),read_df['Financial_Year'].cast('int')-1).otherwise(read_df['Financial_Year'].cast('int'))) \
