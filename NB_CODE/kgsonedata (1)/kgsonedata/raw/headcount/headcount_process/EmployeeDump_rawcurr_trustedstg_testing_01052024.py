...
.option("path",trusted_stg_savepath_url+processName+"/testing_01052024_employee_dump") \
.option("compression","snappy") \
.saveAsTable("kgsonedatadb.testing_01052024_trusted_stg_"+ processName + "_" +table_name)
