...
# DBTITLE 1,Load into Raw History Table
 ...
 .option("path",raw_hist_savepath_url+processName+"/"+tableName+'_test') \
 .option("compression","snappy") \
 .saveAsTable("kgsonedatadb.test_raw_hist_"+ processName + "_" + tableName)

# COMMAND ----------

saveTableName = "kgsonedatadb.test_raw_stg_"+processName + "_"+ tableName
print(tableName)
