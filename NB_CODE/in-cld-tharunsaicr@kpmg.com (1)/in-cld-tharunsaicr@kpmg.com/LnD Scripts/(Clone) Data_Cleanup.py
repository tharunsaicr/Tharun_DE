...
if(layerName.upper() == "RAW" or layerName.upper() == "RAW_ADHOC"):
    ...
    .option("path",raw_stg_savepath_url+processName+"/"+tableName+'_test') \
    .option("compression","snappy") \
...
if(layerName.upper() == "TRUSTED"):
    ...
    .format("delta") \
    .option("overwriteSchema", "True") \
    .option("path",trusted_curr_savepath_url+processName+"/"+tableName+'_test') \
    .option("compression","snappy") \
    .saveAsTable("kgsonedatadb.test_trusted_"+ processName + "_" +tableName)
    ...
    .format("delta") \
    .option("mergeschema","true") \
    .option("path",trusted_hist_savepath_url+processName+"/"+tableName+'_test') \
    .option("compression","snappy") \
    .saveAsTable("kgsonedatadb.test_trusted_hist_"+ processName + "_" + tableName)
...
if (layerName.upper() == "RAW"): 
    dbutils.notebook.run("/Users/in-cld-tharunsaicr@kpmg.com/LnD Scripts/(Clone) rawstg_to_rawcurr_clean_data",6000, {'DeltaTableName':tableName, 'ProcessName':processName})
